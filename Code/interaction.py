...
MY_PORT = 2695
BUFSIZE = 4096 
NET_ID = "LAN>PI" # change depending on network used
...
def writeToFile(y):
    if sys.argv[2] == '-t':
        ...
        p_type = 'UDP'
    di = "../Data/"
    fileName = di + "Interaction_" + NET_ID + "_" + p_type + "_" + str(sys.argv[5]) + "_" + sys.argv[3] + ".txt"
